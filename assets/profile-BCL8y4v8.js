import{s as $,e as B,a as E}from"./showMessage-Do1J44am.js";import{r as H}from"./authGuard-CVD_0xhH.js";import{g as I,a as L,b as P,u as N}from"./profile-DefyQVfd.js";import{r as y}from"./renderListingCard-Ba3jJfl1.js";function c(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function S(t,m){let d="https://placehold.co/1200x200?text=+";t.banner&&t.banner.url&&(d=t.banner.url);let e="https://placehold.co/100x100?text=?";t.avatar&&t.avatar.url&&(e=t.avatar.url);let l="";m&&(l=`
