import{r as N,h as P,a as $,g as L,e as k,d as C,s as M}from"./showMessage-7BOvKEKx.js";import{g as S,a as D}from"./listingEvents-Bn6gD7o8.js";import{f as E,i as T}from"./renderListingCard-Ba3jJfl1.js";import{g as U}from"./profile-Dqhqk4vy.js";function A(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function j(i){if(i.length===0)return'<p class="text-muted">No bids yet. Be the first!</p>';const e=i.slice().sort(function(a,s){return s.amount-a.amount});let t="";for(let a=0;a<e.length;a++){const s=e[a];let n="Unknown";s.bidder&&s.bidder.name&&(n=A(s.bidder.name)),t+=`
      <tr>
        <td>${n}</td>
